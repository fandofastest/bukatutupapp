...
import net.bukatutup.mynewsapp.api.models.posts.post.PostDetails;
...
import net.bukatutup.mynewsapp.utility.TtsEngine;
import net.bukatutup.mynewsapp.adapters.CommentsAdapter;
import net.bukatutup.mynewsapp.api.http.ApiUtils;
import net.bukatutup.mynewsapp.data.constant.AppConstant;
import net.bukatutup.mynewsapp.data.sqlite.FavouriteDbController;
import net.bukatutup.mynewsapp.fragment.WriteACommentFragment;
import net.bukatutup.mynewsapp.listeners.ListItemClickListener;
import net.bukatutup.mynewsapp.models.FavouriteModel;
import net.bukatutup.mynewsapp.webengine.WebEngine;
import net.bukatutup.mynewsapp.webengine.WebListener;
