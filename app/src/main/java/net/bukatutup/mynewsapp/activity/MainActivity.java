...
import net.bukatutup.mynewsapp.api.models.menus.AnyMenu;
import net.bukatutup.mynewsapp.api.models.menus.MainMenu;
...
import net.bukatutup.mynewsapp.adapters.FeaturedPagerAdapter;
import net.bukatutup.mynewsapp.adapters.HomeCategoryAdapter;
import net.bukatutup.mynewsapp.adapters.HomeSelectableCategoryAdapter;
import net.bukatutup.mynewsapp.adapters.MenuCommonAdapter;
...
import net.bukatutup.mynewsapp.data.sqlite.NotificationDbController;
import net.bukatutup.mynewsapp.data.sqlite.SelectableCatDbController;
import net.bukatutup.mynewsapp.listeners.ListItemClickListener;
import net.bukatutup.mynewsapp.models.NotificationModel;
import net.bukatutup.mynewsapp.models.SelectableCategoryModel;
...
public class MainActivity extends BaseActivity {
    ...
    public void loadMenus() {
        ...
        ApiUtils.getApiInterface().getMenus().enqueue(new Callback<List<MainMenu>>() {
            @Override
            public void onResponse(@NonNull Call<List<MainMenu>> call,@NonNull Response<List<MainMenu>> response) {
